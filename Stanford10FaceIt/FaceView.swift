...
//
// 1.了解贝塞尔曲线, 和控制点 .
// 2.** storyboard contentMode 设置为 redraw , 我希望每次bounds变化是都重新画.
// 3. IBDesignable 在storyboard中 , 直接绘制draw函数的内容.
...
class FaceView: UIView {
    ...
    @IBInspectable
    var eyesOopen: Bool = true { didSet { setNeedsDisplay() } }
